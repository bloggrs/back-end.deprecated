...
const { findAll, createCategory, updateCategory, deleteCategory, findByPkOr404 } = require("./categories-dal");
...
CategoryFieldKeys.map(key => CreateCategoryFields[key] = CategoryFields[key].required());
app.post("/categories",[
